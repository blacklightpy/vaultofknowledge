...
As for connections to the idea of conservation in society, that should be separately discussed under my "Socio-Economic Discourse" category, and I've made a draft note for [[the scope of sharing resources]].
