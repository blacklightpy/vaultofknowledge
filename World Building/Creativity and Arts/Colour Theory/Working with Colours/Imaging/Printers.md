...
# Printing Process
Printers use the [CMYK Colour Model](CMYK%20Colour%20Model.md), a [Subtractive Colour Model](subtractive%20colour%20model.md) for printing, beause addition of ink is subtractive. It includes cyan, magenta, yellow and black (key) colours. Black is used to adjust the shadow and contrast of images.
