...
spot colours (generated by ink printed using a single run; C,M,Y,K, etc. in offset printing) (contrast with process colours - CMYK, dots) - used in offset printing (trans) - lithography (planographic method of printing, based on immiscibility of oil and water)
