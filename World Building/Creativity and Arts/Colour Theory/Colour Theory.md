...
- Mixing - Additive / Subtractive - Primary and Secondary Colours
	- Metamerism
- [Complementary colours](Complementary%20colours) produce a high level of contrast - this is used in art
...
# Evolution
- [Newton's Experiments on Colours.](Newton's%20Experiments%20on%20Colours.)
	- He came up with the [colour wheel](colour%20wheel) aka colour circle in the form of a Newton Disc (Disappearing Colour Disc)
		- Colour circle is used for, among other purposes for additive colour mixing. Sometimes, adding two colours from different parts of the spectrum might produce a third colour that looks like a light from another part of the spectrum. This type of colour mixing is called metameric matching - [metamerism](metamerism).
...
- Johan Wolfgang von Goethe, a German poet, proposed his set of [complementary colours](complementary%20colours).
- Thomas Young's  [Trichromatic Theory of Colours](Trichromatic%20Theory%20of%20Colours). It distinguished additive and subtractive colours. He came up with a [colour triangle](colour%20triangle) (also used in CIE 1931 Colour Space)
