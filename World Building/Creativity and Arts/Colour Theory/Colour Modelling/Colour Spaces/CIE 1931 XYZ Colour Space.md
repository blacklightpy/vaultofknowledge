...
The XYZ coordinate system was deliberately designed so that the Y parameter is also a measure of the [[../../Colour Perception/Lightness]] of the colour. The [[../Chromaticity]] is then specified by two derived parameters x and y.
