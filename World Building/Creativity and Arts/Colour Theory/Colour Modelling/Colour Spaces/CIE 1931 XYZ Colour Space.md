...
This model was based of the [[CIE 1931 RGB Colour Space]]. The CIEThis allows representing all hues of the RGB colour space in the 2-dimensional [[CIE xyY Colour Space|xyY]] space derived from XYZ tristimulus values.
