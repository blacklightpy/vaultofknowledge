...
- $\text{LiC}_6$ (Most common, Has a charge density of 372 $\text{mAh/g}$)
- $\text{Li}_4\text{Ti}_5\text{O}_{12}$ (Durable, used in LTO)
- $\text{LiSi}_6$ (Used in Solid State Batteries, In development, Charge density of about 3500-4200 $\text{mAh/g}$)
- $\text{Li (s)}$ (Used in Solid State Batteries, in development, Charge density of about )
