Public Key Infrastructure (PKI) is a system that encapsulates centralized encryption systems like CAs to provide an interface for secure communications. This system has a centralized trust model.
