...
>[!NOTE] Considerations
> The channel through which the messages are relayed should be tamper proof, as a man-in-the-middle could intercept the traffic and send his keys instead of the original keys to read the messages. For this reason, messages are encrypted to a trusted third party server via TLS, and 
# Practice
