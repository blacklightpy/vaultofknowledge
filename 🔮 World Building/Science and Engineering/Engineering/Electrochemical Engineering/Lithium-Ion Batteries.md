...
> [!WARNING]
> Lithium-Polymer batteries, despite using *solid or gel polymer electrolytes* are more dangerous than traditional Lithium-Ion batteries because they also use *liquid electrolytes*, which combined with the high temperature capability of the solid polymers makes it worse. This is in addition to the fact that most Li-Po offerings are single cells that don't come with a BMS.
