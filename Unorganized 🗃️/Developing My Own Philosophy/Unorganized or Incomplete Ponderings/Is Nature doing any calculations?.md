If we consider ray tracing, it would be wrong to assume that nature is performing a Monte Carlo approximation of random sample paths to get the light intensity at a point.
